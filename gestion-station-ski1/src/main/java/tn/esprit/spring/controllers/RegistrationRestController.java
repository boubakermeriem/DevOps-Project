...
public class RegistrationRestController {
    ...
    public RegistrationDTO addAndAssignToSkier(@RequestBody RegistrationDTO registrationDTO,
        ...
        return registrationServices.addRegistrationAndAssignToSkier(registrationDTO, numSkieur);
    }
    ...
    public RegistrationDTO addAndAssignToSkierAndCourse(@RequestBody RegistrationDTO registrationDTO,
        ...
        return registrationServices.addRegistrationAndAssignToSkierAndCourse(registrationDTO, numSkieur, numCourse);
    }
